...
from .fada.target_collector import _concat_target_batches as _concat_target_batches  # noqa: F401
...
from .fada.target_collector import (
    _target_batch_from_window as _target_batch_from_window,  # noqa: F401
)
