...
from unilab.algos.torch.distill.learning.dagger import resolve_command_intent_rollout_policies
...
from unilab.algos.torch.distill.runtime.persistent_resources import (
...
def build_persistent_g1_distillation_runtime(
    *,
    ...
    worker_kwargs = {
        "root_dir": str(Path(__file__).resolve().parents[6]),
        "role_cfgs": {
