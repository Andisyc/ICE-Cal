...
| G1 stand high-support height bundle | `stand_support_height_exp`, `stand_support_height_margin_l2`, support-relative height, contacted feet height, high loaded stand, low crouch | G1 stand-still task config, G1 standing reward owner, foot sensors, reward dispatch, live sentinel logs | High: must reject low crouch without leaking into `G1WalkFlat`, and must not be gameable by missing contact, foot sliding, or floating height | S1/S2/S4; T-value, T-role, T-diff, T-oracle, T-live |
