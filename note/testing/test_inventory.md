...
| `uv run pytest tests/config/test_reward_injection.py -q` | S0, S2 | T-connect, T-oracle, T-diff | U-C-02, U-R-02, G1LOC-C-001, G1LOC-C-002, G1LOC-C-003, G1LOC-C-004; includes upstream posture-anchor equality, G1StandStill high-support bundle ownership, and G1WalkFlat/G1WalkHeight isolation from Standing high-support keys | contract-confirmed |
| `uv run pytest tests/envs/locomotion/g1/test_gait_constraint.py -q` | S1, S2 | T-value, T-role, T-oracle, T-meta, T-diff, T-mask, T-transform | G1LOC-CMD-002, G1LOC-GAIT-001, G1LOC-RWD-001, G1LOC-OBS-001, G1LOC-RWD-002, G1LOC-GAIT-002, G1LOC-GAIT-003, G1LOC-STAND-001, G1LOC-STAND-002, G1LOC-ACT-001; includes stand-still pose/support reward lab ranking and high-support low-crouch ordering | contract-confirmed |
