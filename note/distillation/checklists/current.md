...
| Final fresh Gate 0 materialization | deploy connector + oracle v2 | S1/S3 / T-identity+workload+preflight | PARTIAL | E108: r1 Gate 0 accepted and training later stopped at iteration 4/next aggregate OOM; preserve it and freeze a separate r2 only after a new workload/resource decision |
