...
superseded_by: FADA-METHOD-v024
paper: FADA Few-Shot Domain Adaptation via Dynamics Alignment for Humanoid Control
---

# FADA Method Contract v023

> Historical boundary (2026-09-07): v024 supersedes this phase-only Oracle design. No v023
> training or policy-quality evidence was produced. The `mujoco_fada_phase` selector remains only
> for checkpoint/config compatibility and controlled comparison.
