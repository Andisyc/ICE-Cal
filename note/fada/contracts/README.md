...
| [FADA-CONTEXT-PHASE1-METHOD-v005](active/method/FADA-CONTEXT-PHASE1-METHOD-v005.md) | method | active | Fixed-left-knee-0.9 full-action teacher with forward-progress failure enforcement |
| [FADA-CONTEXT-PHASE1-TRAIN-v005](active/training/FADA-CONTEXT-PHASE1-TRAIN-v005.md) | training | active | UniLab full-action SAC retry with default-off progress termination |
