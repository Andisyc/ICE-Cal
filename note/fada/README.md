...
Active `FADA-METHOD-v014` and `FADA-TRAIN-v014` own source-policy construction. They require one
...
mode authority, while Gait/feet-phase Reward and gait constraints remain disabled. The source
...
future. v013 and earlier source routes are historical.
...
5. `plans/2026-08-27-fada-gain-targeted-oracle-v014.md` and
   `testing/v014_module_test_cards.md` for the current source-training transition
